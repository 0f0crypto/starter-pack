...
The purpose of this document is to develop a set of tools for recognizing license plates in videos, photos and live stream (e.g. a dashboard camera / phone app). 
...
* Example: [SRS Sample](https://krazytech.com/projects/sample-software-requirements-specificationsrs-report-airline-database)
